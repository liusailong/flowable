...
public class test03 {
    ...
    public void testDeploy() {
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("Myholiday001bpmn20.xml")
                .name("创建申请流程")
                .deploy();
    ...
    public void testRunProcess() {
        ...
        varibles.put("assignee1", "丽萍");
        varibles.put("assignee2", "小宝");
        varibles.put("desciption", "工作累了，出去散散心");
        //启动流程实例
        ProcessInstance holidayRequest = runtimeService.startProcessInstanceByKey("myholiady",varibles);
